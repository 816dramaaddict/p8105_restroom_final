...
```{r zipcode_clean, echo = FALSE, message = FALSE, warning = FALSE}
# Download from US Census Bureau
county_shapes <- st_read("./NYC/tl_2023_us_county.shp")

# Filter NYC counties using FIPS codes
nyc_counties <- county_shapes %>%
...
```{r}
# Load the shapefile
zip_shapes <- st_read("./NYC/nyc.shp") %>%
